# Problem7/Tests/test_problem7_eval.py
...
HELPER = ROOT / "eval7.py"   # evaluator for Problem 7
...
def test_every_solution(modname: str):
    ...
    # Run Problem 7 tests and capture count
    try:
...
def pytest_terminal_summary(terminalreporter):
    if _results:
        terminalreporter.write_line("\n=== Problem 7 • Per-file test pass counts ===")
