# Problem10/Tests/test_problem10_eval.py
...
HELPER = ROOT / "eval10.py"   # evaluator for Problem 10

# Folder containing solutions (adjust if your files live elsewhere, e.g., llama/Self_debug)
...
def test_every_solution(modname: str):
    ...
    try:
        ...
        # Optional: confirm which file got imported
    ...
    assert True  # don't fail; collect all files

def pytest_terminal_summary(terminalreporter):
    if _results:
        terminalreporter.write_line("\n=== Problem 10 • Per-file test pass counts ===")
